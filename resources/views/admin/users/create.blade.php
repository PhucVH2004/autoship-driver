...
@section('content')
<div class="mb-4">
    <h1 class="page-heading">Thêm người dùng mới</h1>
...
<div class="data-table-wrapper" style="max-width:580px;">
    <div class="table-header"><h5><i class="bi bi-person-plus me-2 text-primary"></i>Thông tin tài khoản</h5></div>
    <div class="p-4">
        @if($errors->any())
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Nguyễn Văn A">
            </div>
            <div class="mb-3">
            ...
            <div class="row g-3 mb-3">
                <div class="col-sm-6">
                    <label class="form-label fw-bold" style="font-size:.88rem;">Mật khẩu <span class="text-danger">*</span></label>
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Ít nhất 6 ký tự">
                </div>
                <div class="col-sm-6">
                    <label class="form-label fw-bold" style="font-size:.88rem;">Xác nhận mật khẩu <span class="text-danger">*</span></label>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-sm-6">
                    ...
                    <select name="trang_thai" class="form-select">
                        <option value="Hoat dong" {{ old('trang_thai','Hoat dong') === 'Hoat dong' ? 'selected' : '' }}>Hoạt động</option>
                        <option value="Khoa" {{ old('trang_thai') === 'Khoa' ? 'selected' : '' }}>Bị khoá</option>
                    </select>
                </div>
            </div>
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary rounded-3"><i class="bi bi-check2 me-1"></i>Tạo tài khoản</button>
