...
@section('content')
<div class="mb-4">
    <h1 class="page-heading">Sửa vai trò: {{ $role->name }}</h1>
...
<div class="data-table-wrapper" style="max-width:540px;">
    <div class="table-header"><h5><i class="bi bi-shield me-2 text-primary"></i>Chỉnh sửa vai trò</h5></div>
    <div class="p-4">
        @if($errors->any())
        ...
        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="mo_ta" class="form-control" rows="3">{{ old('mo_ta', $role->mo_ta) }}</textarea>
            </div>
